            ...
            <div style="background: var(--bg-main); padding: 1.25rem; border-radius: 0.5rem;">
                ...
                <div id="cancelReasonPanel" style="display: none; margin-top: 1rem; padding: 1rem; background: rgba(239, 68, 68, 0.05); border: 1px solid rgba(239, 68, 68, 0.25); border-radius: 0.5rem;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
                        <button class="action-btn danger" data-oid="${order.id}" data-reason="Didn't Respond" onclick="cancelOrderWithReason(this.dataset.oid, this.dataset.reason)">Didn't Respond</button>
                        <button class="action-btn danger" data-oid="${order.id}" data-reason="No Valid TG" onclick="cancelOrderWithReason(this.dataset.oid, this.dataset.reason)">No Valid TG</button>
                        <button class="action-btn danger" data-oid="${order.id}" data-reason="Didn't Pay" onclick="cancelOrderWithReason(this.dataset.oid, this.dataset.reason)">Didn't Pay</button>
                        <button class="action-btn danger" data-oid="${order.id}" data-reason="Retard" onclick="cancelOrderWithReason(this.dataset.oid, this.dataset.reason)">Retard</button>
                    </div>
