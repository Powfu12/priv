                ...
                ${filteredOrders.map(order => `
                    <tr>
                        ...
                        <td>
                            ...
                            <small style="opacity: 0.7">${order.personalInfo.email}</small>
                        </td>
                        <td>${order.package.name}</td>
                        <td><strong>€${order.payment.total.toFixed(2)}</strong></td>
...
function filterOrders() {
    ...
    filteredOrders = allOrders.filter(order => {
        ...
        const searchMatch = !searchInput ||
            order.orderCode.toLowerCase().includes(searchInput) ||
            order.personalInfo.fullName.toLowerCase().includes(searchInput) ||
            order.personalInfo.email.toLowerCase().includes(searchInput) ||
            order.personalInfo.telegram.toLowerCase().includes(searchInput);
...
function viewOrder(orderId) {
    ...
    modalBody.innerHTML = `
        ...
        <div class="detail-group">
            ...
            <div class="detail-value">${formatDateTime(order.timestamp)}</div>
        </div>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid rgba(255,215,0,0.3);">
            ...
            <div class="detail-group">
                ...
                <div class="detail-value">${order.personalInfo.fullName}</div>
            </div>
            <div class="detail-group">
                <div class="detail-label">Email</div>
                <div class="detail-value">${order.personalInfo.email}</div>
            </div>
            <div class="detail-group">
                <div class="detail-label">Phone</div>
                <div class="detail-value">${order.personalInfo.phone}</div>
            </div>
            <div class="detail-group">
                <div class="detail-label">Telegram</div>
                <div class="detail-value">${order.personalInfo.telegram}</div>
            </div>
        </div>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid rgba(255,215,0,0.3);">
            ...
            <div class="detail-group">
                ...
                <div class="detail-value">${order.package.name}</div>
            </div>
            <div class="detail-group">
                <div class="detail-label">Price</div>
                <div class="detail-value">€${order.package.price.toFixed(2)}</div>
            </div>
        </div>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid rgba(255,215,0,0.3);">
            ...
            <div class="detail-group">
                ...
                <div class="detail-value">${order.shipping.method} (€${order.shipping.methodPrice.toFixed(2)})</div>
            </div>
            <div class="detail-group">
                <div class="detail-label">Delivery Type</div>
                <div class="detail-value">${order.shipping.type}</div>
            </div>
            <div class="detail-group">
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid rgba(255,215,0,0.3);">
            ...
            <div class="detail-group">
                ...
                <div class="detail-value" style="font-size: 24px; color: #FFD700;">€${order.payment.total.toFixed(2)}</div>
            </div>
        </div>
    `;
